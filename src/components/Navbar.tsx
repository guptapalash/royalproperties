...
const Navbar = () => {
  return (
    <Popover className='container mx-12 max-w-full flex items-center px-6 border-b-2 h-24'>
        <img src="./assets/logo2.svg" alt="logo" className='h-[64px]' />
        ...
        <div>
          <Link className='sm:block font-medium hidden' href="">+91-9892116965</Link>
        </div>
    </Popover>
  )
}
